...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.pushButton_4.clicked.connect(self.plotCountConsinants)
    ...
    def newFileSelector(self):
        ...
        self.filePath = QFileDialog.getOpenFileName(self, "QFileDialog.getOpenFileName()", "", "TextFile (*.txt)",
                                                    options=options)
